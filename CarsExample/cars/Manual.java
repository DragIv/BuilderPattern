...
public class Manual {
    ...
    public String print() {
        ...
        info += "CarsExample.components.Engine: volume - " + engine.getVolume() + "; mileage - " + engine.getMileage() + "\n";
        info += "CarsExample.components.Transmission: " + transmission + "\n";
